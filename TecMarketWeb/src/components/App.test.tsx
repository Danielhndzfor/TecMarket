...
const mockAddProductRequest = addProductRequest as jest.MockedFunction<typeof addProductRequest>;
...
describe('ProductListing Component', () => {
  beforeEach(() => {
    mockGetProducts.mockResolvedValue(mockResponse as AxiosResponse<any>);
  });
...
describe('AddProduct Component', () => {
  ...
  test('envía los datos del formulario correctamente', async () => {
    ...
    mockAddProductRequest.mockResolvedValue({ 
      data: {},
      status: 201,
      statusText: 'OK',
...
describe('AddProduct Component', () => {
  ...
  await waitFor(() => mockAddProductRequest.mock.calls.length === 1);
